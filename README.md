# Blinkered dictionary: Indonesian

The Indonesian word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Indonesian.

**33,725 of 41,132 candidates proved — 82.0%**, across 6 independent
families, 4 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Indonesian, and why those
...
Candidates come from Blinkered's Indonesian list, which lives in
[`blinkered-attestation/candidates/id`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/id).
